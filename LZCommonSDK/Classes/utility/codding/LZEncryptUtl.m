			   ...
			   context:(CCOperation)encryptOrDecrypt
{
    ...
    if (encryptOrDecrypt == kCCDecrypt) {
        dTextIn = [[LZEncryptUtl decodeBase64WithString:sTextIn] mutableCopy];
    }
    else{
    ...
    else
    {
        ...
        sResult = [LZEncryptUtl encodeBase64WithData:dResult];
    }
    return sResult;
}
...
{
	return [LZEncryptUtl encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
}
